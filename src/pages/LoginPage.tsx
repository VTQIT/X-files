    ...
    <div className="min-h-[100dvh] flex items-center justify-center px-4" style={{ background: '#0A0A0A' }}>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#888] mt-1">Sign in to your vault</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-[#222] bg-[#111] accent-[#FF6B35]" />
        ...
        <p className="text-center text-sm text-[#888] mt-6">
          ...
          <button onClick={() => navigate('/register')} className="text-[#FF6B35] hover:underline">
            Create one
          </button>
        </p>
      </div>
